...
def start():
    pars = Site_parser()
    final_cat_urls = {'Редукторы': '/equipment/gas-pressure-reducers', 'Регуляторы': '/equipment/gas-pressure-regulators'}
    all_produkts = []
    ...
    write_items_in_file(all_produkts, 'rezalt/uploads_gas_welding_equipment.csv')
